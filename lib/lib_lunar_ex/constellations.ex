defmodule LibLunarEx.Constellations do
  ...
  def locate(%Body{ra: ra, dec: dec} = body) do
    %{body | constellation: name_for_location(%{ra: ra, dec: dec})}
  end

  defp name_for_location(%{ra: ra, dec: dec}) do
    prsd_ra = ra.h + ra.m / 60.0 + ra.s / 3600.0
    prsd_dec = dec.d + dec.m / 60.0 + dec.s / 3600.0

    parse_coordinate_item(prsd_ra, prsd_dec, @coordinates)
    |> constellation_name
  end

  defp name_for_location(%{err: :exec_error}) do
    "exec error"
  end

  defp parse_coordinate_item(_ra, _dec, []), do: "unk"

  defp parse_coordinate_item(ra, dec, [first | rest]) do
    if elem(first, 0) < ra && elem(first, 1) > ra && elem(first, 2) < dec do
      elem(first, 3)
    else
      parse_coordinate_item(ra, dec, rest)
    end
  end

  defp constellation_name("And"), do: "Andromeda"
  defp constellation_name("Ant"), do: "Antlia"
  defp constellation_name("Aps"), do: "Apus"
  defp constellation_name("Aql"), do: "Aquila"
  defp constellation_name("Aqr"), do: "Aquarius"
  defp constellation_name("Ara"), do: "Ara"
  defp constellation_name("Ari"), do: "Aries"
  defp constellation_name("Aur"), do: "Auriga"
  defp constellation_name("Boo"), do: "Bo\u00f6tes"
  defp constellation_name("CMa"), do: "Canis Major"

  defp constellation_name("CMi"), do: "Canis Minoris"
  defp constellation_name("CVn"), do: "Canum Venaticorum"
  defp constellation_name("Cae"), do: "Caelum"
  defp constellation_name("Cap"), do: "Capricornus"
  defp constellation_name("Car"), do: "Carina"
  defp constellation_name("Cas"), do: "Cassiopeia"
  defp constellation_name("Cen"), do: "Centaurus"
  defp constellation_name("Cep"), do: "Cepheus"
  defp constellation_name("Cet"), do: "Cetus"
  defp constellation_name("Cha"), do: "Chamaeleon"

  defp constellation_name("Cir"), do: "Circinus"
  defp constellation_name("Cnc"), do: "Cancer"
  defp constellation_name("Col"), do: "Columba"
  defp constellation_name("Com"), do: "Coma Berenices"
  defp constellation_name("CrA"), do: "Corona Australis"
  defp constellation_name("CrB"), do: "Corona Borealis"
  defp constellation_name("Crt"), do: "Crater"
  defp constellation_name("Cru"), do: "Crux"
  defp constellation_name("Crv"), do: "Corvus"
  defp constellation_name("Cyg"), do: "Cygnus"

  defp constellation_name("Del"), do: "Delphinus"
  defp constellation_name("Dor"), do: "Dorado"
  defp constellation_name("Dra"), do: "Draco"
  defp constellation_name("Equ"), do: "Equuleus"
  defp constellation_name("Eri"), do: "Eridanus"
  defp constellation_name("For"), do: "Fornax"
  defp constellation_name("Gem"), do: "Gemini"
  defp constellation_name("Gru"), do: "Grus"
  defp constellation_name("Her"), do: "Hercules"
  defp constellation_name("Hor"), do: "Horologium"
  defp constellation_name("Hya"), do: "Hydra"
  defp constellation_name("Hyi"), do: "Hydrus"
  defp constellation_name("Ind"), do: "Indus"
  defp constellation_name("LMi"), do: "Leo Minor"
  defp constellation_name("Lac"), do: "Lacerta"
  defp constellation_name("Leo"), do: "Leo"
  defp constellation_name("Lep"), do: "Lepus"

  defp constellation_name("Lib"), do: "Libra"
  defp constellation_name("Lup"), do: "Lupus"
  defp constellation_name("Lyn"), do: "Lynx"
  defp constellation_name("Lyr"), do: "Lyra"
  defp constellation_name("Men"), do: "Mensa"
  defp constellation_name("Mic"), do: "Microscopium"
  defp constellation_name("Mon"), do: "Monoceros"

  defp constellation_name("Mus"), do: "Musca"
  defp constellation_name("Nor"), do: "Norma"
  defp constellation_name("Oct"), do: "Octans"
  defp constellation_name("Oph"), do: "Ophiuchus"
  defp constellation_name("Ori"), do: "Orion"
  defp constellation_name("Pav"), do: "Pavo"
  defp constellation_name("Peg"), do: "Pegasus"
  defp constellation_name("Per"), do: "Perseus"
  defp constellation_name("Phe"), do: "Phoenix"
  defp constellation_name("Pic"), do: "Pictor"
  defp constellation_name("PsA"), do: "Piscis Austrinus"
  defp constellation_name("Psc"), do: "Pisces"

  defp constellation_name("Pup"), do: "Puppis"
  defp constellation_name("Pyx"), do: "Pyxis"
  defp constellation_name("Ret"), do: "Reticulum"
  defp constellation_name("Scl"), do: "Sculptor"
  defp constellation_name("Sco"), do: "Scorpius"
  defp constellation_name("Sct"), do: "Scutum"
  defp constellation_name("Ser"), do: "Serpens"
  defp constellation_name("Sex"), do: "Sextans"
  defp constellation_name("Sge"), do: "Sagitta"
  defp constellation_name("Sgr"), do: "Sagittarius"

  defp constellation_name("Tau"), do: "Taurus"
  defp constellation_name("Tel"), do: "Telescopium"
  defp constellation_name("TrA"), do: "Triangulum Australe"
  defp constellation_name("Tuc"), do: "Tucana"
  defp constellation_name("UMa"), do: "Ursa Major"
  defp constellation_name("UMi"), do: "Ursa Minor"
  defp constellation_name("Vel"), do: "Vela"
  defp constellation_name("Vir"), do: "Virgo"
  defp constellation_name("Vol"), do: "Volans"
  defp constellation_name("Vul"), do: "Vulpecula"

  defp constellation_name(const_abbr), do: "unknown abbreviation #{const_abbr}"
end
